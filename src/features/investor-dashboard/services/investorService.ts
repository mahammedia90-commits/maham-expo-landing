...
const mockEvents: MerchantEvent[] = [
  // ── حالية ──
  { id: 'ie1', name: 'فعالية على خطاه', description: 'فعالية كبرى تحتاج مساحات متنوعة. فرصة مثالية لعرض مساحاتك للتجار المشاركين في رحلة من مكة إلى المدينة.', location: 'مكة المكرمة - المدينة المنورة', city: 'مكة المكرمة', startDate: '2026-03-01', endDate: '2026-03-30', availableBooths: 15, totalBooths: 40, type: 'cultural', status: 'active', image: 'https://mmnews.tv/wp-content/uploads/2026/02/Ala-Khutah-project.webp' },
  { id: 'ie2', name: 'موسم الرياض 2025-2026', description: 'أضخم حدث ترفيهي في المنطقة. طلب عالي على المساحات والقاعات والمحلات التجارية في جميع المناطق.', location: 'بوليفارد وورلد، بوليفارد سيتي', city: 'الرياض', startDate: '2025-10-10', endDate: '2026-03-31', availableBooths: 40, totalBooths: 200, type: 'entertainment', status: 'active', image: 'https://images.unsplash.com/photo-1663900108404-a05e8bf82cda?w=800&h=400&fit=crop&q=80' },
  { id: 'ie3', name: 'LEAP 2026', description: 'أكبر مؤتمر تقني في العالم. فرصة لتأجير مساحات المعارض والقاعات بأسعار مميزة لشركات التقنية.', location: 'مركز الرياض الدولي للمؤتمرات والمعارض', city: 'الرياض', startDate: '2026-03-13', endDate: '2026-03-16', availableBooths: 25, totalBooths: 80, type: 'technology', status: 'active', image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&h=400&fit=crop&q=80' },
  { id: 'ie4', name: 'بينالي الدرعية 2026', description: 'فعالية فنية عالمية. احتياج لمساحات عرض ومحلات تجارية في حي جاكس التاريخي.', location: 'حي جاكس، الدرعية', city: 'الرياض', startDate: '2026-01-30', endDate: '2026-05-02', availableBooths: 10, totalBooths: 30, type: 'cultural', status: 'active', image: 'https://images.unsplash.com/photo-1544967082-d9d25d867d66?w=800&h=400&fit=crop&q=80' },

  // ── قادمة ──
  { id: 'ie5', name: 'معرض الرياض التجاري', description: 'معرض تجاري شامل يجذب أكثر من 200 تاجر. احتياج كبير لمساحات العرض والمستودعات.', location: 'الرياض - مركز المعارض', city: 'الرياض', startDate: '2026-04-10', endDate: '2026-04-20', availableBooths: 30, totalBooths: 60, type: 'exhibition', status: 'upcoming', image: 'https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=800&h=400&fit=crop&q=80' },
  { id: 'ie6', name: 'مهرجان الطعام السعودي', description: 'مهرجان يجمع أشهر المطاعم والطهاة. فرص تأجير مساحات المطاعم والبوثات على الواجهة البحرية.', location: 'الواجهة البحرية', city: 'جدة', startDate: '2026-05-01', endDate: '2026-05-15', availableBooths: 20, totalBooths: 45, type: 'entertainment', status: 'upcoming', image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800&h=400&fit=crop&q=80' },
  { id: 'ie7', name: 'FSB Sports Show Riyadh 2026', description: 'معرض رياضي دولي. طلب مرتفع على مساحات العرض الكبيرة ومناطق البوثات للموردين الرياضيين.', location: 'مركز الرياض الدولي للمعارض', city: 'الرياض', startDate: '2026-06-15', endDate: '2026-06-17', availableBooths: 18, totalBooths: 50, type: 'sports', status: 'upcoming', image: 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=800&h=400&fit=crop&q=80' },
  { id: 'ie8', name: 'كأس العالم للرياضات الإلكترونية 2026', description: 'بطولة عالمية تجذب جمهوراً ضخماً. فرص استثمارية مميزة في تأجير المساحات والمحلات التجارية.', location: 'بوليفارد سيتي', city: 'الرياض', startDate: '2026-08-01', endDate: '2026-08-30', availableBooths: 22, totalBooths: 70, type: 'sports', status: 'upcoming', image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&h=400&fit=crop&q=80' },
  { id: 'ie9', name: 'Africa Coffee Expo 2026', description: 'معرض متخصص في صناعة القهوة. فرصة لتأجير مساحات المحامص والمقاهي.', location: 'مركز المعارض', city: 'جدة', startDate: '2026-07-20', endDate: '2026-07-23', availableBooths: 12, totalBooths: 35, type: 'exhibition', status: 'upcoming', image: 'https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=800&h=400&fit=crop&q=80' },
  { id: 'ie10', name: 'المؤتمر السعودي البحري 2026', description: 'مؤتمر متخصص في القطاع البحري. احتياج لقاعات مؤتمرات ومساحات عرض.', location: 'مركز المؤتمرات', city: 'الدمام', startDate: '2026-09-16', endDate: '2026-09-17', availableBooths: 10, totalBooths: 30, type: 'conference', status: 'upcoming', image: 'https://images.unsplash.com/photo-1724364552281-dbed323c4633?w=800&h=400&fit=crop&q=80' },
  { id: 'ie11', name: 'معرض الطاقة الشمسية وتخزين الطاقة', description: 'معرض حلول الطاقة المتجددة. فرص تأجير مساحات عرض واسعة لشركات الطاقة.', location: 'مركز الرياض الدولي للمعارض', city: 'الرياض', startDate: '2026-09-22', endDate: '2026-09-24', availableBooths: 15, totalBooths: 40, type: 'exhibition', status: 'upcoming', image: 'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&h=400&fit=crop&q=80' },
  { id: 'ie12', name: 'سوق السفر السعودي 2026', description: 'معرض السياحة والسفر. فرص تأجير محلات ومساحات عرض لشركات الطيران والفنادق.', location: 'مركز الرياض للمعارض', city: 'الرياض', startDate: '2026-10-05', endDate: '2026-10-08', availableBooths: 14, totalBooths: 45, type: 'exhibition', status: 'upcoming', image: 'https://images.unsplash.com/photo-1763455892848-39bbc7ca90a0?w=800&h=400&fit=crop&q=80' },
  { id: 'ie13', name: 'معرض المدن الذكية - السعودية', description: 'فعالية حلول المدن الذكية. فرص تأجير مساحات تقنية مجهزة بالكامل.', location: 'مركز الرياض الدولي للمؤتمرات', city: 'الرياض', startDate: '2026-11-10', endDate: '2026-11-13', availableBooths: 16, totalBooths: 50, type: 'technology', status: 'upcoming', image: 'https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?w=800&h=400&fit=crop&q=80' },
];
