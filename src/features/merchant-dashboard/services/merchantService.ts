...
const mockEvents: MerchantEvent[] = [
  ...
  { id: 'e3', name: 'معرض بدايات 2026', description: 'معرض فني وثقافي يسلّط الضوء على بدايات الحركة الفنية السعودية ويستعرض أعمال رواد الفن التشكيلي في المملكة.', location: 'المتحف الوطني السعودي', city: 'الرياض', startDate: '2026-01-27', endDate: '2026-04-11', availableBooths: 12, totalBooths: 40, type: 'cultural', status: 'active', image: 'https://images.unsplash.com/photo-1531243269054-5ebf6f34081e?w=800&h=400&fit=crop&q=80' },
  { id: 'e4', name: 'بينالي الدرعية 2026', description: 'فعالية فنية عالمية تجمع أبرز الفنانين من حول العالم في حي جاكس التاريخي بالدرعية. منصة مثالية للعلامات التجارية الفاخرة.', location: 'حي جاكس، الدرعية', city: 'الرياض', startDate: '2026-01-30', endDate: '2026-05-02', availableBooths: 18, totalBooths: 60, type: 'cultural', status: 'active', image: 'https://images.unsplash.com/photo-1544967082-d9d25d867d66?w=800&h=400&fit=crop&q=80' },
  { id: 'e5', name: 'LEAP 2026', description: 'أحد أكبر المؤتمرات التقنية في العالم. يجمع قادة التقنية والابتكار والشركات الناشئة من أكثر من 170 دولة.', location: 'مركز الرياض الدولي للمؤتمرات والمعارض', city: 'الرياض', startDate: '2026-03-13', endDate: '2026-03-16', availableBooths: 60, totalBooths: 300, type: 'technology', status: 'active', image: 'https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800&h=400&fit=crop&q=80' },

  // ── الفعاليات القادمة ──
  { id: 'e6', name: 'معرض الرياض التجاري', description: 'معرض تجاري شامل يضم أفضل العلامات التجارية المحلية والدولية في قلب الرياض.', location: 'الرياض - مركز المعارض', city: 'الرياض', startDate: '2026-04-10', endDate: '2026-04-20', availableBooths: 50, totalBooths: 200, type: 'exhibition', status: 'upcoming', image: 'https://images.unsplash.com/photo-1587825140708-dfaf72ae4b04?w=800&h=400&fit=crop&q=80' },
  { id: 'e7', name: 'مهرجان الطعام السعودي', description: 'مهرجان يجمع أشهر المطاعم والطهاة لتقديم أفضل الأطباق السعودية والعالمية في أجواء ساحلية مميزة.', location: 'الواجهة البحرية', city: 'جدة', startDate: '2026-05-01', endDate: '2026-05-15', availableBooths: 35, totalBooths: 80, type: 'entertainment', status: 'upcoming', image: 'https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800&h=400&fit=crop&q=80' },
  { id: 'e8', name: 'FSB Sports Show Riyadh 2026', description: 'معرض رياضي دولي يجمع أكثر من 200 مورد محلي ودولي متخصص في البنية التحتية الرياضية والملاعب والمرافق.', location: 'مركز الرياض الدولي للمؤتمرات والمعارض', city: 'الرياض', startDate: '2026-06-15', endDate: '2026-06-17', availableBooths: 40, totalBooths: 150, type: 'sports', status: 'upcoming', image: 'https://images.unsplash.com/photo-1461896836934-ffe607ba8211?w=800&h=400&fit=crop&q=80' },
  { id: 'e9', name: 'كأس العالم للرياضات الإلكترونية 2026', description: 'بطولة عالمية كبرى للرياضات الإلكترونية تجذب جمهوراً ضخماً من عشاق الألعاب حول العالم مع فرص تجارية مميزة.', location: 'بوليفارد سيتي', city: 'الرياض', startDate: '2026-08-01', endDate: '2026-08-30', availableBooths: 45, totalBooths: 180, type: 'sports', status: 'upcoming', image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?w=800&h=400&fit=crop&q=80' },
  { id: 'e10', name: 'المؤتمر السعودي البحري 2026', description: 'مؤتمر متخصص في القطاع البحري يستعرض أحدث التقنيات والفرص في الصناعات البحرية والموانئ.', location: 'مركز المؤتمرات', city: 'الدمام', startDate: '2026-09-16', endDate: '2026-09-17', availableBooths: 20, totalBooths: 80, type: 'conference', status: 'upcoming', image: 'https://images.unsplash.com/photo-1724364552281-dbed323c4633?w=800&h=400&fit=crop&q=80' },
  { id: 'e11', name: 'سوق السفر السعودي 2026', description: 'معرض متخصص في قطاع السياحة والسفر يجمع شركات الطيران والفنادق ووكالات السفر والسياحة.', location: 'مركز الرياض للمعارض', city: 'الرياض', startDate: '2026-10-05', endDate: '2026-10-08', availableBooths: 30, totalBooths: 120, type: 'exhibition', status: 'upcoming', image: 'https://images.unsplash.com/photo-1763455892848-39bbc7ca90a0?w=800&h=400&fit=crop&q=80' },
  { id: 'e12', name: 'معرض المدن الذكية - السعودية', description: 'فعالية تجمع كبار الموردين والخبراء في حلول المدن الذكية والتقنيات الحضرية المتقدمة ضمن رؤية 2030.', location: 'مركز الرياض الدولي للمؤتمرات', city: 'الرياض', startDate: '2026-11-10', endDate: '2026-11-13', availableBooths: 35, totalBooths: 140, type: 'technology', status: 'upcoming', image: 'https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?w=800&h=400&fit=crop&q=80' },
  { id: 'e13', name: 'Africa Coffee Expo 2026', description: 'معرض متخصص في صناعة القهوة يجمع المنتجين والموردين والمحامص من أفريقيا والعالم.', location: 'مركز المعارض', city: 'جدة', startDate: '2026-07-20', endDate: '2026-07-23', availableBooths: 25, totalBooths: 90, type: 'exhibition', status: 'upcoming', image: 'https://images.unsplash.com/photo-1447933601403-0c6688de566e?w=800&h=400&fit=crop&q=80' },
  { id: 'e14', name: 'معرض الطاقة الشمسية وتخزين الطاقة', description: 'معرض يركز على حلول الطاقة المتجددة والطاقة الشمسية وتقنيات تخزين الطاقة المتقدمة.', location: 'مركز الرياض الدولي للمعارض', city: 'الرياض', startDate: '2026-09-22', endDate: '2026-09-24', availableBooths: 28, totalBooths: 100, type: 'exhibition', status: 'upcoming', image: 'https://images.unsplash.com/photo-1508514177221-188b1cf16e9d?w=800&h=400&fit=crop&q=80' },

  // ── الفعاليات المنتهية ──
  { id: 'e15', name: 'IFAT Saudi Arabia 2026', description: 'الحدث الوحيد في المملكة المخصص لتقنيات النفايات والمياه والبيئة. جمع خبراء البيئة من حول العالم.', location: 'مركز الرياض الدولي للمعارض', city: 'الرياض', startDate: '2026-01-26', endDate: '2026-01-28', availableBooths: 0, totalBooths: 90, type: 'exhibition', status: 'ended', image: 'https://images.unsplash.com/photo-1470071459604-3b5ec3a7fe05?w=800&h=400&fit=crop&q=80' },
  { id: 'e16', name: 'معرض مكة بيلدكس 2026', description: 'معرض متخصص في العقار والبناء والصناعة والديكور، يجمع أبرز الشركات والمقاولين في المنطقة الغربية.', location: 'مركز المعارض', city: 'مكة المكرمة', startDate: '2026-01-15', endDate: '2026-01-18', availableBooths: 0, totalBooths: 110, type: 'exhibition', status: 'ended', image: 'https://images.unsplash.com/photo-1504307651254-35680f356dfd?w=800&h=400&fit=crop&q=80' },
];
