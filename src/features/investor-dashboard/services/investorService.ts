...
const mockSpaces: InvestorSpace[] = [
  ...
  { id: 'sp4', name: 'منطقة الوحدات - مركز المعارض', location: 'مركز الرياض الدولي للمعارض', city: 'الرياض', area: 2000, type: 'unit_area', photos: [], pricePerMonth: 45000, pricePerDay: 3000, status: 'available', amenities: ['كهرباء', 'إنترنت', 'تكييف', 'أمن', 'نظافة'], capacity: 100, rating: 4.9, totalBookings: 18 },
...
const mockBookings: InvestorBooking[] = [
  ...
  { id: 'bk3', spaceId: 'sp4', spaceName: 'منطقة الوحدات - مركز المعارض', merchantName: 'شركة الإلكترونيات المتقدمة', merchantPhone: '+966 50 555 6666', startDate: '2026-04-01', endDate: '2026-04-05', totalAmount: 15000, status: 'pending', createdAt: '2026-02-25', notes: 'معرض تقنية - 20 وحدة' },
  ...
  { id: 'bk6', spaceId: 'sp4', spaceName: 'منطقة الوحدات - مركز المعارض', merchantName: 'مؤسسة الصناعات الحرفية', merchantPhone: '+966 50 222 3333', startDate: '2026-03-20', endDate: '2026-03-25', totalAmount: 15000, status: 'pending', createdAt: '2026-02-27' },
];
...
const mockRevenue: InvestorRevenue[] = [
  ...
  { id: 'rv3', month: 'نوفمبر 2025', amount: 92000, source: 'قاعة الملتقى + منطقة الوحدات', bookingsCount: 5 },
...
const mockContracts: InvestorContract[] = [
  ...
  { id: 'ic4', merchantName: 'شركة الإلكترونيات المتقدمة', spaceName: 'منطقة الوحدات', startDate: '2026-04-01', endDate: '2026-04-05', totalValue: 15000, paidAmount: 0, remainingAmount: 15000, status: 'pending' },
];

// Events data imported from shared encyclopedia
import { getInvestorEvents } from '@/shared/constants/eventsData';
const mockEvents: MerchantEvent[] = getInvestorEvents();
