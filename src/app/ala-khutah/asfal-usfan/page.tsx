...
export const metadata: Metadata = {
  title: 'منطقة أسفل عسفان | وحدات فعالية على خطاه - Maham Expo',
  description:
    'احجز وحدتك في منطقة أسفل عسفان ضمن فعالية على خطاه. مساحات تجارية للمطاعم والتجزئة متاحة للحجز عبر مهام إكسبو.',
