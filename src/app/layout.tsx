...
export const metadata: Metadata = {
  title: "مهام اكسبو - فعاليات الرياض | Maham Expo | تأجير بوثات على خطاه",
  description:
  ...
  keywords:
    "مهام اكسبو, فعاليات الرياض, مهام اكسبو فعاليات الرياض, على خطاه, فعالية على خطاه, تأجير بوثات, بوثات على خطاه, فعاليات الرياض الكبرى, Maham Expo, مهام إكسبو, Ala Khutah, booth rental Riyadh, معارض السعودية, إيجار مساحات تجارية, مساحات فعاليات, استثمار فعاليات, بوثات مطاعم, بوثات تجزئة, رحلة مكة المدينة, موسم الرياض, exhibitions Saudi Arabia, events Riyadh",
