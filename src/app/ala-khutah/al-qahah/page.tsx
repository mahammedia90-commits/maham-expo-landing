...
export const metadata: Metadata = {
  title: 'منطقة القاحة | وحدات فعالية على خطاه - Maham Expo',
  description:
    'احجز وحدتك في منطقة القاحة ضمن فعالية على خطاه. مساحات تجارية للمطاعم والتجزئة متاحة للحجز عبر مهام إكسبو.',
